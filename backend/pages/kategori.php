    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3">Buuubeauty</div>
            </a>
...
<table class="table table-striped table-hover" width="100%" border="1" cellspacing="2" cellpadding="2">
    ...
    <tbody>
        ...
        ?>
            <tr >
                ...
                <button type="button" class="btn  btn-outline-danger m-2"><a href="../process/delete_kategori.php?=$row['id']?>"
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Made with <i class="fa fa-heart" aria-hidden="true"></i> by Ikma</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <script src="../aseets/js/sb-admin-2.min.js"></script>
